...
{
    private final static String TAG = VideoRendererView.class.getSimpleName();
    ...
    public void setParams(boolean fullScreenRequired, ByteBuffer buffer, int bufferWidth, int bufferHeight)
    {
